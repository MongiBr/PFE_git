...
/* harmony import */ var contexts_cart_cart_context__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! contexts/cart/cart.context */ "./contexts/cart/cart.context.tsx");
...
/* harmony import */ var contexts_language_language_context__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! contexts/language/language.context */ "./contexts/language/language.context.js");
var _this = undefined,
...
var MagasinPage = function MagasinPage(_ref) {
  ...
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(contexts_language_language_context__WEBPACK_IMPORTED_MODULE_10__["default"]),
      lang = _useContext.state.lang;

  console.log(magasin);

  var _useContext2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(contexts_cart_cart_context__WEBPACK_IMPORTED_MODULE_7__["CartContext"]),
      add = _useContext2.add,
      update = _useContext2.update,
      products = _useContext2.products;

  var data = magasin;
  var index = Object(helper_utility__WEBPACK_IMPORTED_MODULE_8__["findProductIndex"])(products, data.id);
  var quantity = Object(helper_utility__WEBPACK_IMPORTED_MODULE_8__["getProductQuantity"])(products, index);
  ...
  }, magasin.name), __jsx(_ProductDetails_style__WEBPACK_IMPORTED_MODULE_4__["ProductWeight"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 103,
  ...
  }, magasin.email), __jsx(_ProductDetails_style__WEBPACK_IMPORTED_MODULE_4__["ProductDescription"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 104,
...
//# sourceMappingURL=[id].js.73852eb8a5b9225ae541.hot-update.js.map