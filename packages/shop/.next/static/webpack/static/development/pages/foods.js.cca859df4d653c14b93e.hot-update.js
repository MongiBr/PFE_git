...
/* harmony import */ var components_RestaurantCard_RestaurantCard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! components/RestaurantCard/RestaurantCard */ "./components/RestaurantCard/RestaurantCard.tsx");
...
var ServiceProviders = function ServiceProviders(_ref) {
  ...
  var _useQuery = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_5__["useQuery"])(_graphql_query_serviceProvider_query__WEBPACK_IMPORTED_MODULE_6__["GET_SERVICE_PROVIDERS"], {
    variables: {
      offset: 0,
      limit: fetchLimit
    }
  ...
  var handleOnClick = react__WEBPACK_IMPORTED_MODULE_1___default.a.useCallback(function (id) {
    var as = "/serviceProvider/".concat(id);
    router.push(as);
  }, []);
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_ServiceProvidersList_style__WEBPACK_IMPORTED_MODULE_4__["ProductsRow"], {
    ...
    }, __jsx(components_RestaurantCard_RestaurantCard__WEBPACK_IMPORTED_MODULE_3__["default"], {
      data: item,
      onClick: function onClick(id) {
        return handleOnClick(id);
      },
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=foods.js.cca859df4d653c14b93e.hot-update.js.map