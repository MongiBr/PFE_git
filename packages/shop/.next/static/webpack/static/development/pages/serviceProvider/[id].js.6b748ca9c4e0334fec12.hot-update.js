...
/* harmony import */ var containers_ServiceProvider_ServiceProvider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! containers/ServiceProvider/ServiceProvider */ "./containers/ServiceProvider/ServiceProvider.tsx");
...
var MagasinPage = function MagasinPage(_ref) {
  ...
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(contexts_language_language_context__WEBPACK_IMPORTED_MODULE_12__["default"]),
      lang = _useContext.state.lang;

  console.log(magasin);

  var _useContext2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(contexts_cart_cart_context__WEBPACK_IMPORTED_MODULE_9__["CartContext"]),
      add = _useContext2.add,
      update = _useContext2.update,
      products = _useContext2.products;

  var data = magasin;
  var index = Object(helper_utility__WEBPACK_IMPORTED_MODULE_10__["findProductIndex"])(products, data.id);
  ...
  })), __jsx(containers_ServiceProvider_ServiceProvider__WEBPACK_IMPORTED_MODULE_8__["default"], {
    type: magasin.type.toLowerCase(),
    deviceType: deviceType,
    loadMore: false,
    fetchLimit: 10,
    __self: _this,
...
//# sourceMappingURL=[id].js.6b748ca9c4e0334fec12.hot-update.js.map