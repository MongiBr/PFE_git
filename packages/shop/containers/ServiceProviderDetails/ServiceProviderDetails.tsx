...
import OrderRecivedWrapper, {
  ...
  InfoBlockWrapper,
  InfoBlock,
} from "./ServiceProviderDetails.style";

import { FormattedMessage } from "react-intl";
import { useRouter } from "next/router";
import data from "containers/Checkout/data";
const PAGE_TYPE = "grocery";

type ServiceProviderProps = { deviceType: any; data: any };

const ServiceProviderDetails: React.FunctionComponent<ServiceProviderProps> = ({
  deviceType,
  data,
}) => {
